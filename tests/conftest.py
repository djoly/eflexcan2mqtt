...
@pytest.fixture
def data10_level1_alarm() -> List[int]:
    """Represents the compiled, aggregated bytes from a set of 10X messages containing a level 1 alarm and open charge/discharge relays."""
    return [
        0x04,0x0E,0x02,0x13,0xFF,0xFB,0x50,
        0x00,0x10,0x00,0x02,0x12,0x01,0x01,
        0x01,0xF4,0x02,0x58,0x00,0x01,0x2A,
        0x0C,0xF8,0x01,0x0C,0xF7,0x06,0x64,
        0x49,0x45,0x25,0x00,0x02,0xF5,0xF5,
        0x02,0x15,0xFF,0xFF,0x00,0x00,0x1E,
